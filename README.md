...
* Chapter 2 Basics of Random Matrix Theory
	...
	* Section 2.5 [Spiked model](https://htmlpreview.github.io/?https://github.com/Zhenyu-LIAO/RMT4ML/blob/master/Matlab_resource/2.5/html/spiked_models.html)
		...
		* Section 2.5.2 [Isolated eigenvectors](https://htmlpreview.github.io/?https://github.com/Zhenyu-LIAO/RMT4ML/blob/master/Matlab_resource/2.5/html/spiked_models.html)
...
* Chapter 5 Large Neural Networks
	...
	* Section 5.2 Beyond random weights: gradient descent dynamics in learning linear neural nets
	* Section 5.3 Recurrent neural nets: echo-state works
